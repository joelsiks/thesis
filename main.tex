...
\usepackage[T1]{fontenc}
\usepackage[scaled=0.85]{FiraMono}            % load a nice TT font
...
\title{Addressing Fragmentation in ZGC through Custom Allocators}
\subtitle{Leveraging a Lean, Mean, Free-List Machine}
